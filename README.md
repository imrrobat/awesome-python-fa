...
<a href="https://www.coffeebede.com/mrrobat"><img class="img-fluid" src="https://coffeebede.ir/DashboardTemplateV2/app-assets/images/banner/default-yellow.svg" /></a>
...
- [کتابخانه هاي TUI](#کتابخانه-هاي-tui)
...
- [textual](https://github.com/Textualize/textual) - فریم‌ورک مدرن برای ساخت اپلیکیشن‌های ترمینالی با پایتون و ری‌اکتیو.
- [urwid](https://github.com/urwid/urwid) - ساخت رابط کاربری ترمینال با قابلیت مدیریت رویداد و ویجت‌های متنوع.
- [rich](https://github.com/Textualize/rich) - کتابخانه‌ای برای پرینت رنگی و زیبا در ترمینال با پشتیبانی از جدول، پروگرس‌بار و کدهای رنگی.
- [prompt_toolkit](https://github.com/prompt-toolkit/python-prompt-toolkit) - ساخت promptهای قابل تعامل با تکمیل خودکار، تاریخچه و پشتیبانی از layout.
- [npyscreen](https://github.com/npcole/npyscreen) - فریم‌ورک سریع برای ساخت فرم‌ها و منوهای ترمینالی.
- [blessed](https://github.com/jquast/blessed) - رابط ساده‌تر برای کار با curses و ایجاد افکت‌های ترمینالی.
- [asciimatics](https://github.com/peterbrittain/asciimatics) - انیمیشن و طراحی UI در ترمینال بدون نیاز به curses.
- [py_cui](https://github.com/jwlodek/py_cui) - ساخت رابط‌های مبتنی بر شبکه با ویجت‌های ساده در ترمینال.
- [terminaltables](https://github.com/Robpol86/terminaltables) - ساخت جدول‌های متنی ساده در ترمینال.
- [bullet](https://github.com/bchao1/bullet) - ساخت منوهای انتخابی تعاملی با طراحی ساده.
- [python-inquirer](https://github.com/magmax/python-inquirer) - ابزار ساخت پرسش‌نامه‌های CLI به سبک inquirer.js.
- [console-menu](https://github.com/aegirhall/console-menu) - ساخت منوهای CLI چندسطحی ساده.
- [simple-term-menu](https://github.com/IngoMeyer441/simple-term-menu) - ساخت منوهای انتخابی خطی مینیمال با قابلیت انتخاب چندگانه.
- [click-shell](https://github.com/click-contrib/click-shell) - ترکیب click با shell-like interface برای ساخت CLI تعاملی.

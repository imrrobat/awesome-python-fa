...
- [**moviepy**](https://github.com/Zulko/moviepy)
 - کتابخانه‌ای برای ویرایش فیلم‌ها با پایتون. moviepy به شما این امکان را می‌دهد که ویدیوها را برش دهید، افکت‌ها را اعمال کنید، صدا را ویرایش کنید و ویدیوهای جدید بسازید. این کتابخانه از فرمت‌های مختلف پشتیبانی می‌کند و امکانات زیادی برای پردازش و ویرایش ویدیو دارد.
